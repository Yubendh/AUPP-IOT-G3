...
- Explaination: everytime ESP32 takes a reading, it stores that number into a list, which it holds the last 5 readings. Afterward, the code adds all the 5 numbers together 
