...
- Explaination: everytime ESP32 takes a reading, it stores that number into a list, which it holds the last 5 readings. Afterward, the code find the average of the readings and i
